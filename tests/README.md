...
| **Full Project Compilation** | `project_tools/` | Validates `ore mktool` compiling complex, multi-file projects (Go modules, Node.js/TS packages, full Cargo workspaces) into portable `.wasm` cartridges. |
